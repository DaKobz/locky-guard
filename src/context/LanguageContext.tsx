...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "demo.tip": "Astuce: Pour cette démo, utilisez le mot de passe \"locky123\"",
    ...
    "continue": "Continuer",
    "pay.once.browser": "Acheter maintenant (19,99€)",
    "pay.once.stripe": "Payer avec Stripe (19,99€)",
  ...
  en: {
    ...
    "demo.tip": "Tip: For this demo, use the password \"locky123\"",
    "authenticating": "Authenticating...",
    "unlock": "Unlock",
    "use.biometrics": "Use biometrics",
    "data.security": "Locky Guard securely stores your data only on your device.",
    ...
    "password.strength.weak": "Weak - Add special characters, numbers, and uppercase letters",
    "password.strength.medium": "Medium - Add another character category",
    ...
    "creating": "Creating...",
    "master.password.warning": "This password is the key to your vault. Save it somewhere safe as it cannot be recovered if forgotten.",
    "master.password.warning.title": "Important",
    ...
    "support.email": "Support: support@locky.app",
    "continue": "Continue",
    "pay.once.browser": "Buy now ($19.99)",
    "pay.once.stripe": "Pay with Stripe ($19.99)",
